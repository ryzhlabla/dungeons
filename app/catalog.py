...
def build_catalog(content):
    ...
    for sid, scene in ordered:
        ...
        if discovery:
            ...
            lines.append(f"| {scene['step']:03d} | Осмотреться | {cell(result)} | Свет лампы; запись в дневник только при первом осмотре | ui:inspect |")
